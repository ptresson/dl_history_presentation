...
\author[Paul Tresson]{\textbf{Paul Tresson}}
\date{03/06/26} % or whatever the date you are presenting in is
...
\begin{frame}{First Neural Network Model : The Perceptron}
$$
y =
\begin{bmatrix}
    w_1&
...
\begin{columns}[t]
    ...
    \vspace{1cm}
    \begin{itemize}
        \item<1-> Non-linearity (\textit{e.g.} ReLu)
        \item<2-> Multi Layer Perceptron
...
\begin{frame}{Sidestep : Transformers}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=.7\linewidth]{./figs/transformer3b1b.png}
    \end{figure}
    \nonumbernote{\href{https://www.youtube.com/@3blue1brown}{Adapted from 3blue1brown}}
\end{frame}
